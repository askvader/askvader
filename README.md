...
Askvader is a typed, purely functional language that compiles to the cloud. It can be used to provision cloud runtime environments like Kubernetes or AWS, or used as a programming language in its own right. The core design goals are:
